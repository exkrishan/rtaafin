...
"[project]/app/api/ingest/s3-index/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const s3IngestPrefix = undefined;
 ...
 */ async function getDevManifest(callId) {
    const dataDir = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(process.cwd(), 'data', callId);
    try {
        const files = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["readdir"])(dataDir);
        // Filter chunk files and extract seq numbers
        const manifest = files.filter((f)=>/^chunk-\d+\.json$/.test(f)).map((f)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__12f21aa7._.js.map