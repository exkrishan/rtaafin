...
"[project]/app/api/calls/intent/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('intents').select('intent, confidence, created_at, seq').eq('call_id', callId).order('seq', {
            ascending: false
        }).limit(1);
        if (error) {
        ...
        if (!data || data.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: 'No intent found for this call'
            }, {
                status: 404
            });
        }
...
async function POST(req) {
    try {
        ...
        if (!body.callId || body.seq === undefined || !body.intent || body.confidence === undefined) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: 'Missing required fields: callId, seq, intent, confidence'
            }, {
                status: 400
            });
        }
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('intents').insert({
            call_id: body.callId,
            seq: body.seq,
            intent: body.intent,
            confidence: body.confidence,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__456ee14b._.js.map