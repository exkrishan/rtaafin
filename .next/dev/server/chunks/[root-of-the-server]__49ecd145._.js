...
"[project]/app/api/ingest/check/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!callId || !seqParam) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: 'Missing callId or seq parameter'
            }, {
                status: 400
            });
        }
        ...
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('ingest_events').select('seq').eq('call_id', callId).eq('seq', seq).limit(1);
            if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__49ecd145._.js.map