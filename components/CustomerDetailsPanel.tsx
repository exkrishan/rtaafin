            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900">{customer.masked_phone}</span>
                </div>
                {customer.email && (
                  <div className="flex justify-between">
                ...
                {customer.account && (
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900">{customer.account}</span>
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="space-y-4">
              ...
              <div className="space-y-3">
                {customer.lastInteractions.map((interaction, i) => (
                  <div key={i} className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    {interaction.caseId && (
                      <div className="text-xs text-gray-600">Case: {interaction.caseId}</div>
                    )}
                  </div>
                ))}
              </div>
            ...
            {onOpenCaseHistory && (
              <button
                ...
                className="w-full mt-4 px-4 py-2 bg-gray-100 text-gray-700 text-sm font-medium rounded hover:bg-gray-200 transition-colors"
              >
