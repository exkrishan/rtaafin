...
export interface LeftSidebarProps {
  ...
  onResetCall?: () => void;
  onRestartCall?: () => void;
  // Pause/Resume props kept for backward compatibility but buttons removed for Live UI
  isPaused?: boolean;
  onPauseCall?: () => void;
  onResumeCall?: () => void;
}
...
export default function LeftSidebar({ 
  ...
  onResetCall,
  onRestartCall,
  // Pause/Resume props accepted but not used (buttons removed for Live UI)
  isPaused: _isPaused,
  onPauseCall: _onPauseCall,
  onResumeCall: _onResumeCall,
}: LeftSidebarProps) {
  ...
  return (
    <div className="w-16 bg-white border-r border-gray-200 flex flex-col items-center py-4 gap-0">
      ...
      {/* Start/Stop Call (Pause/Resume removed for Live UI) */}
